...
public class Collatz
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1 -> " + collatz(1));
        System.out.println("2 -> " + collatz(2));
        System.out.println("3 -> " + collatz(3));
        System.out.println("4 -> " + collatz(4));
        System.out.println("5 -> " + collatz(5));
        System.out.println("6 -> " + collatz(6));
